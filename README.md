# Fall 2025: Foundation models for spatial-time series

[Zoom link](https://m1p.org/go_zoom2)

[Course page](https://m1p.org/index.php/Functional_Data_Analysis)
...
| Nikita Kiselev | Diffusion Forcing: Next-token Prediction Meets Full-Sequence Diffusion | [Slides](student_talks/diffusion_forcing_kiselev/diffusion_forcing.pdf), [Code](student_talks/diffusion_forcing_kiselev/diffusion_forcing.ipynb) |
| Petr Babkin | Modern State Space Models: S4, S5, MAMBA, HIPPO | [Slides](https://github.com/intsystems/ODE_with_LLMs/blob/petr/ssm/ssm/main.ipynb), [Code](https://github.com/intsystems/ODE_with_LLMs/blob/petr/ssm/ssm/main.ipynb) |
...
| Nikita Kiselev | Rayleigh–Bénard Convection | [Slides](student_talks_physics/kiselev_rayleigh_benard_convection/rayleigh_benard_convection.pdf), [Code](student_talks_physics/kiselev_rayleigh_benard_convection/rayleigh_benard_convection.ipynb) |
| Petr Babkin | Модели с лагранжианом и гамильтонианом | [Slides](https://github.com/petr-parker/hnn-lnn/blob/main/HNN_LNN.pdf), [Code](https://github.com/petr-parker/hnn-lnn/blob/main/HNN_Spring_Notebook.ipynb) |
