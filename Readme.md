...
| GBM  | [PyTorch Geometric Temporal](https://pytorch-geometric-temporal.readthedocs.io/en/latest/modules/dataset.html#module-torch_geometric_temporal.dataset.chickenpox) |  Yes    |            Fork of pytorch-geometric, works with temporal graphs, has a lot of implemented dataset classes, **NB!** too few commits in since 2022 |
